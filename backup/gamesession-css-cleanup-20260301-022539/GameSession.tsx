...
const GameSession = () => {
  ...
  */
      ...
      case 'journal':
        return (
          <>
            ...
            <h3 className="sidebar-subheading">Rumors</h3>
            <div className="quest-list">
              {rumors.length ? (
                rumors.map(rumor => (
                  <div
      ...
      case 'loadout':
        return (
          <>
            ...
            {activeLoadoutTab === 'inventory' ? (
              ...
              <>
                {unlockedSkills.length ? (
                  <>
                    <h4 className="sidebar-subheading">Techniques</h4>
                ...
                {unlockedSpells.length ? (
                  <>
                    <h4 className="sidebar-subheading">Spells</h4>
                    <div className="spell-list">
            ...
            <h4 className="sidebar-subheading">Equipped</h4>
            {equipment.length ? (
              <div className="boon-list">
                {equipment.map((entry, index) => (
                  <div className="inventory-item" key={`${entry}-${index}`}>
                    <span>{entry}</span>
                    <span className="item-count">Equipped</span>
                  </div>
                ))}
              </div>
            ) : (
              <p className="empty-text">No items equipped.</p>
            )}

            <h4 className="sidebar-subheading">Artifacts &amp; Boons</h4>
            {artifacts.length ? (
              <div className="boon-list">
  ...
  const sidebarButtons = [
    { section: 'journal' as SidebarSection, icon: BookOpen, label: 'Journal' },
    { section: 'stats' as SidebarSection, icon: User, label: 'Stats' },
    { section: 'loadout' as SidebarSection, icon: Package, label: 'Loadout' },
    { section: 'social' as SidebarSection, icon: Users, label: 'NPCs' }
  ]
